    ...
    <>
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Tag
            label={lang === "ru" ? "Все категории" : "All categories"}
          ...
          {PROJECT_CATEGORIES.map((category) => (
            <Tag
              key={category.id}
              label={lang === "ru" ? category.label.ru : category.label.en}
      ...
      {grouped.completed.length > 0 && grouped.inProgress.length > 0 && (
        <div className="mb-6 flex items-center gap-2 text-sm text-muted-foreground">
          {lang === "ru" ? "Выполненные проекты" : "Completed projects"}
      ...
      {grouped.inProgress.length > 0 && (
        <>
          <div className="mb-6 mt-10 flex items-center gap-2 text-sm text-muted-foreground">
